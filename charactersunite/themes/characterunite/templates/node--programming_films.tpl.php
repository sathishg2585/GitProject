...
<!-- initiativesHeader end -->
	<div class="initiativeMain layoutWide">
		<div id="colMain">
			...
			<?php if ($field_transcript_description != '') { ?>
			...
			<div class="mod full">
				<div class="mainstageHeader">
					<h2 class="blackhead blackheadsmall"><span style="font-size:18px;"><?php echo $field_ds_title_1;?></span><strong style="font-size:22px;"><?php echo $field_ds_title_2;?></strong></h2>
				</div>
				<section class="copy clearfix">
